...
import { Award, HeartHandshake, Sparkles, ShieldCheck, Leaf, Star, User } from "lucide-react";
...
const whyUs = [
  { title: "Cosmetic-led dentistry", body: "Every restoration is shaped, shaded and polished to look indistinguishable from natural enamel.", img: "/images/dental-chair.jpg" },
  ...
  { title: "Modern, guided workflows", body: "Digital scans, computer-guided implants and rotary endodontics — faster, more precise, less invasive.", img: "/images/reception.jpg" },
];

function DoctorPlaceholder() {
  return (
    <div className="aspect-[4/3] w-full rounded-t-3xl bg-gradient-to-br from-sage-soft via-accent-soft to-sage-soft flex flex-col items-center justify-center gap-3">
      ...
      <section className="pt-8 md:pt-12 pb-12 grid md:grid-cols-2 gap-10 items-center">
        <div>
          ...
          <Reveal delay={0.16}>
            <div className="mt-6 space-y-4 text-[15px] leading-relaxed text-muted-foreground">
              <p>
                ShailDent The Dental Studio was founded by Dr. Shailaja with a clear mission — to
                bring world-class aesthetic dentistry to Rajkot, delivered in a space that feels
                nothing like a traditional clinic.
              </p>
              <p>
                Every detail, from the curved ceilings and sculpted wall art to the soft sage
                seating, was chosen to undo dental anxiety the moment you step in. Behind the calm
                exterior is a fully digital, cosmetic-led practice using guided implants, digital
                smile design and modern endodontics.
              </p>
              <p>
                The result is a studio where routine cleanings and complete smile makeovers are
                delivered with the same standard — meticulous, unhurried and deeply personal.
              </p>
            </div>
          </Reveal>
        </div>
        <Reveal delay={0.12}>
          <img
            ...
            alt="ShailDent reception"
            className="aspect-[4/5] w-full rounded-[1.75rem] object-cover ring-1 ring-border shadow-soft"
          />
        </Reveal>
      </section>
        ...
        <Reveal>
          <div className="h-full rounded-3xl border border-border bg-card p-7 shadow-card">
            ...
            <p className="mt-4 font-display text-2xl text-foreground leading-snug">
              To deliver aesthetic, painless dentistry that treats every patient like family —
              without compromise on quality or comfort.
            </p>
          </div>
        </Reveal>
        <Reveal delay={0.08}>
          <div className="h-full rounded-3xl border border-border bg-card p-7 shadow-card">
            ...
            <p className="mt-4 font-display text-2xl text-foreground leading-snug">
              To become Gujarat's most trusted destination for smile design — known for artistry,
              ethics and an unrushed patient experience.
            </p>
          </div>
        </Reveal>
      </section>
            ...
            <div className="overflow-hidden rounded-3xl border border-border bg-card shadow-card">
              ...
              <div className="p-6">
                ...
                <p className="text-sm text-accent font-semibold">
                  Founder · Cosmetic & Aesthetic Dentist
                </p>
                <p className="mt-3 text-sm text-muted-foreground">
                  An aesthetic-first dentist who believes great care begins with a calm, honest
                  conversation. Known for her gentle hand, eye for detail and lifelong-patient
                  relationships.
                </p>
              </div>
            </div>
          ...
          <Reveal delay={0.08}>
            <div className="overflow-hidden rounded-3xl border border-border bg-card shadow-card">
              ...
              <div className="p-6">
                ...
                <p className="mt-3 text-sm text-muted-foreground">
                  Hand-picked for warmth and skill. From your first call to your follow-up, every
                  interaction is meant to make you feel looked after.
                </p>
              </div>
            </div>
          </Reveal>
              ...
              <div className="flex flex-col items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-muted-foreground">
                    Consistently rated by real patients
                  </div>
                </div>
              </div>
              <div className="flex flex-col items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-muted-foreground">
                    Founded and led by Dr. Shailaja
                  </div>
                </div>
              </div>
              <div className="flex flex-col items-center gap-3">
