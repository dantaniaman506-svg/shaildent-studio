...
function DoctorPlaceholder() {
  return (
    <div className="aspect-[4/5] w-full rounded-[1.75rem] bg-gradient-to-br from-sage-soft via-accent-soft to-sage-soft flex flex-col items-center justify-center gap-4 ring-1 ring-border shadow-soft">
      <div className="flex h-24 w-24 items-center justify-center rounded-full bg-primary/10 ring-2 ring-primary/20">
        <User className="h-12 w-12 text-primary/40" />
      </div>
      <p className="text-xs text-muted-foreground font-medium tracking-wide">Photo coming soon</p>
    </div>
  );
}
  ...
  return (
    <div>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl px-5 pt-8 md:pt-16 pb-16 md:pb-24 grid gap-10 md:grid-cols-2 items-center">
          <div>
            <Reveal>
              <div
                className="inline-flex items-center gap-2 rounded-full border border-accent/30 bg-accent/10 px-3 py-1.5 text-[11px] font-semibold uppercase tracking-[0.18em] text-accent"
            ...
            <Reveal delay={0.08}>
              <h1 className="mt-5 font-display text-[44px] leading-[1.05] md:text-[68px] md:leading-[1.02] font-semibold tracking-tight text-foreground">
                ...
                <br className="hidden md:block" /> Healthy teeth,{" "}
                <span className="font-script text-accent">happy you.</span>
              </h1>
            </Reveal>
            <Reveal delay={0.16}>
              <p
                className="mt-5 max-w-xl text-[15px] md:text-base leading-relaxed text-muted-foreground"
                style={{ fontFamily: "var(--font-poppins)" }}
              >
                Advanced, personalised dental care by{" "}
                <span className="text-foreground font-semibold">Dr. Shailaja</span> — delivered in
                a calm, luxuriously designed studio in Mota Mava, Rajkot.
              </p>
            </Reveal>
            <Reveal delay={0.24}>
              <div
              ...
              >
                <Link
                  ...
                  className="inline-flex items-center gap-2 rounded-full bg-accent px-6 py-3 text-sm font-semibold text-accent-foreground shadow-gold hover:opacity-90 transition"
                >
            ...
            <Reveal delay={0.32}>
              ...
              >
                ...
                <span>
                  <span className="font-semibold text-foreground">5.0</span> · Loved by patients on
                  Google
                </span>
              </div>
            </Reveal>
        ...
        <div className="md:col-span-7">
          ...
          <Reveal delay={0.08}>
            <h2 className="mt-5 font-display text-4xl md:text-5xl font-semibold text-foreground">
              Care that's <span className="font-script text-accent">gentle</span>, precise, and
              deeply personal.
            </h2>
          </Reveal>
          <Reveal delay={0.16}>
            <p className="mt-5 text-[15px] leading-relaxed text-muted-foreground">
              Dr. Shailaja founded ShailDent with a simple belief: dentistry should never feel
              rushed, cold or transactional. Every patient is met with patience and a treatment plan
              tailored to their face, habits and goals. From a five-minute polish to a full smile
              makeover, the standard of care is the same — meticulous, modern, and unhurried.
            </p>
          </Reveal>
          <Reveal delay={0.24}>
            <blockquote className="mt-7 rounded-2xl border-l-4 border-accent bg-card p-5 shadow-card">
              ...
              <p className="mt-2 font-script text-xl md:text-2xl text-foreground leading-snug">
                "A great smile isn't designed in a lab — it's understood in conversation, and
                crafted with care."
              </p>
        ...
        <div className="flex items-end justify-between gap-4 flex-wrap">
          <Reveal>
            ...
            <p
              ...
              style={{ fontFamily: "var(--font-poppins)" }}
            >
              Scroll through — every video auto-plays as it enters view. Tap to unmute or pause.
            </p>
          </Reveal>
          <Reveal>
            <div
              className="inline-flex items-center gap-1.5 rounded-full bg-accent/10 px-3 py-1.5 text-[11px] font-semibold text-accent"
              style={{ fontFamily: "var(--font-poppins)" }}
            >
        ...
        <div className="mt-8 grid gap-4 md:grid-cols-6 md:grid-rows-2 md:auto-rows-fr">
          ...
          <Reveal delay={0.05} className="md:col-span-2">
            <div className="h-full overflow-hidden rounded-3xl ring-1 ring-border shadow-card aspect-[4/3] md:aspect-auto">
              <img
                ...
                alt="ShailDent consultation room"
          ...
          <Reveal delay={0.1} className="md:col-span-2">
            <ScrollVideo
              ...
              poster="/images/dental-chair.jpg"
            ...
            return (
              <Reveal key={s.slug} delay={i * 0.05}>
                <Link
                  to="/services"
                  hash={s.slug}
                  className="group block overflow-hidden rounded-3xl border border-border bg-card shadow-card transition-all duration-300 hover:-translate-y-1 hover:shadow-soft"
                >
                  {/* Icon header instead of photo */}
                  <div className="relative flex h-28 items-center justify-center bg-gradient-to-br from-sage-soft to-accent-soft">
                    <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-background/80 backdrop-blur text-accent shadow-card transition-transform duration-300 group-hover:scale-110">
      ...
      <section className="mx-auto max-w-7xl px-5 py-20 md:py-28">
        <Reveal>
          <SectionLabel>Why ShailDent</SectionLabel>
        </Reveal>
        <Reveal delay={0.08}>
          <h2 className="mt-4 font-display text-4xl md:text-5xl font-semibold text-foreground max-w-2xl">
          ...
          {[
            {
              ...
              body: "We listen first. Every plan is explained until you're fully comfortable proceeding.",
            },
            {
              icon: Sparkles,
              title: "Aesthetic-First Mindset",
              body: "Designed by a cosmetic specialist — every restoration is finished to a mirror polish.",
            },
            {
              icon: ShieldCheck,
              title: "Hospital-Grade Sterilisation",
              body: "Autoclaved instruments, sealed pouches and single-use barriers on every chair.",
            },
            {
              icon: Star,
              title: "5.0 Rated Care",
              body: "Consistently rated 5 stars on Google by patients across Rajkot.",
            },
            {
              icon: Phone,
              title: "Always Reachable",
              body: "Direct WhatsApp and call line — get answers from our team within minutes.",
            },
            {
              icon: Quote,
              title: "Women-Owned Studio",
              body: "Founded and led by Dr. Shailaja — a calm, welcoming space for every patient.",
            },
          ].map((f, i) => {
            const Icon = f.icon;
            return (
          ...
          {reviews.slice(0, 3).map((r, i) => (
            <Reveal key={r.name} delay={i * 0.06}>
              <div className="h-full rounded-3xl border border-border bg-card p-6 shadow-card">
                ...
                <p className="mt-4 italic text-foreground leading-relaxed line-clamp-5">
                  "{r.text}"
                </p>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
              {[
                ...
                <div key={s.l}>
                  ...
                  <div className="mt-2 text-xs md:text-sm uppercase tracking-[0.18em] opacity-80">
                    {s.l}
                  </div>
                </div>
              ))}
      ...
      <section className="mx-auto max-w-3xl px-5 py-20 md:py-28 text-center">
        <Reveal>
          <SectionLabel>Book Today</SectionLabel>
        </Reveal>
        <Reveal delay={0.08}>
          <h2 className="mt-5 font-display text-4xl md:text-5xl font-semibold text-foreground">
        ...
        <Reveal delay={0.16}>
          <p className="mt-4 text-muted-foreground">
            Reach us on WhatsApp or call directly — we typically reply within minutes during clinic
            hours.
          </p>
        </Reveal>
        <Reveal delay={0.24}>
          <div className="mt-8 flex justify-center flex-wrap gap-3">
            <Link
              to="/contact"
              hash="appointment-form"
              className="inline-flex items-center gap-2 rounded-full bg-accent px-6 py-3 text-sm font-semibold text-accent-foreground shadow-gold hover:opacity-90"
            >
              Book Appointment <ArrowRight className="h-4 w-4" />
            </Link>
            <a
